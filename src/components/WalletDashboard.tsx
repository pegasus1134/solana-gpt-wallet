...
import { GPTService, WalletCommand } from '@/services/gpt.service';
...
const FREE_RPC_URL = 'https://api.mainnet-beta.solana.com';
...
const WalletDashboard: React.FC = () => {
    ...
    const updateUsdcBalance = async () => {
        if (!publicKey) return;
        try {
            const tokenAccounts = await customConnection.getParsedTokenAccountsByOwner(
                publicKey,
